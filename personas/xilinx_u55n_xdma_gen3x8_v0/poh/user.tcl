...
# mm2s_ingress_egress_fifos
  ...
  # Create instance: in_dwidth_converter, and set properties
  set in_dwidth_converter [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_dwidth_converter:1.1 in_dwidth_converter ]
  set_property CONFIG.M_TDATA_NUM_BYTES {36} $in_dwidth_converter


  # Create instance: mm2s, and set properties
  set block_name mm2s_ingress_egress_fifos
  set block_cell_name mm2s
  if { [catch {set mm2s [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    set_property -dict [list \
    CONFIG.EGRESS_DATA_WIDTH {512} \
    CONFIG.INGRESS_DATA_WIDTH {512} \
  ] $mm2s


  # Create instance: out_dwidth_converter, and set properties
  set out_dwidth_converter [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_dwidth_converter:1.1 out_dwidth_converter ]
  set_property CONFIG.M_TDATA_NUM_BYTES {64} $out_dwidth_converter


  # Create instance: sha256, and set properties
  set sha256 [ create_bd_cell -type ip -vlnv xilinx.com:hls:sha256:1.0 sha256 ]
  ...
  connect_bd_intf_net -intf_net in_dwidth_converter_M_AXIS [get_bd_intf_pins in_dwidth_converter/M_AXIS] [get_bd_intf_pins sha256/in_r]
  connect_bd_intf_net -intf_net mm2s_s_axis_in [get_bd_intf_pins in_dwidth_converter/S_AXIS] [get_bd_intf_pins mm2s/s_axis_in]
  connect_bd_intf_net -intf_net out_dwidth_converter_M_AXIS [get_bd_intf_pins mm2s/s_axis_out] [get_bd_intf_pins out_dwidth_converter/M_AXIS]
  connect_bd_intf_net -intf_net sha256_out_r [get_bd_intf_pins out_dwidth_converter/S_AXIS] [get_bd_intf_pins sha256/out_r]
  ...
  connect_bd_intf_net -intf_net smartconnect_dma_M01_AXI [get_bd_intf_pins mm2s/s_axi] [get_bd_intf_pins smartconnect_dma/M01_AXI]

  # Create port connections
  connect_bd_net -net core_clk_hbm_axi_clk [get_bd_pins core_clk/hbm_axi_clk] [get_bd_pins core_reset/slowest_sync_clk] [get_bd_pins hbm/AXI_31_ACLK] [get_bd_pins in_dwidth_converter/aclk] [get_bd_pins mm2s/aclk] [get_bd_pins out_dwidth_converter/aclk] [get_bd_pins sha256/ap_clk] [get_bd_pins smartconnect_dma/aclk1]
  connect_bd_net -net core_reset_interconnect_aresetn [get_bd_pins core_reset/interconnect_aresetn] [get_bd_pins in_dwidth_converter/aresetn] [get_bd_pins out_dwidth_converter/aresetn]
  connect_bd_net -net core_reset_peripheral_aresetn [get_bd_pins core_reset/peripheral_aresetn] [get_bd_pins hbm/AXI_31_ARESET_N] [get_bd_pins mm2s/aresetn] [get_bd_pins sha256/ap_rst_n]
  ...
  assign_bd_address -offset 0x8000000000000000 -range 0x8000000000000000 -target_address_space [get_bd_addr_spaces shell_axi_dma] [get_bd_addr_segs mm2s/s_axi/reg0] -force
