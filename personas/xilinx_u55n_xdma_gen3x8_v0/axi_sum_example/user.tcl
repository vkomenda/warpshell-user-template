...
proc cr_bd_user { parentCell } {
  ...
  xilinx.com:hls:axi_sum_example:1.0\
  ...
  # Create instance: axi4_to_axi3_0, and set properties
  set axi4_to_axi3_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_protocol_converter:2.1 axi4_to_axi3_0 ]
  ...
  # Create instance: axi_sum_example, and set properties
  set axi_sum_example [ create_bd_cell -type ip -vlnv xilinx.com:hls:axi_sum_example:1.0 axi_sum_example ]
  ...
  connect_bd_intf_net -intf_net axi4_to_axi3_0_M_AXI [get_bd_intf_pins axi4_to_axi3_0/M_AXI] [get_bd_intf_pins hbm/SAXI_30]
  ...
  connect_bd_intf_net -intf_net axi_sum_example_m_axi_gmem [get_bd_intf_pins axi4_to_axi3_0/S_AXI] [get_bd_intf_pins axi_sum_example/m_axi_gmem]
  ...
  connect_bd_intf_net -intf_net smartconnect_ctrl_M01_AXI [get_bd_intf_pins axi_sum_example/s_axi_control] [get_bd_intf_pins smartconnect_ctrl/M01_AXI]
  ...
  connect_bd_net -net core_clk_hbm_axi_clk [get_bd_pins axi4_to_axi3_0/aclk] [get_bd_pins axi_sum_example/ap_clk] [get_bd_pins core_clk/hbm_axi_clk] [get_bd_pins core_reset/slowest_sync_clk] [get_bd_pins hbm/AXI_30_ACLK] [get_bd_pins hbm/AXI_31_ACLK] [get_bd_pins smartconnect_ctrl/aclk2] [get_bd_pins smartconnect_dma/aclk1]
  connect_bd_net -net core_reset_peripheral_aresetn [get_bd_pins axi4_to_axi3_0/aresetn] [get_bd_pins axi_sum_example/ap_rst_n] [get_bd_pins core_reset/peripheral_aresetn] [get_bd_pins hbm/AXI_30_ARESET_N] [get_bd_pins hbm/AXI_31_ARESET_N]
  ...
  assign_bd_address -offset 0x00000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces axi_sum_example/Data_m_axi_gmem] [get_bd_addr_segs hbm/SAXI_30/HBM_MEM00] -force
  assign_bd_address -offset 0x10000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces axi_sum_example/Data_m_axi_gmem] [get_bd_addr_segs hbm/SAXI_30/HBM_MEM01] -force
  assign_bd_address -offset 0x20000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces axi_sum_example/Data_m_axi_gmem] [get_bd_addr_segs hbm/SAXI_30/HBM_MEM02] -force
  assign_bd_address -offset 0x30000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces axi_sum_example/Data_m_axi_gmem] [get_bd_addr_segs hbm/SAXI_30/HBM_MEM03] -force
  assign_bd_address -offset 0x40000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces axi_sum_example/Data_m_axi_gmem] [get_bd_addr_segs hbm/SAXI_30/HBM_MEM04] -force
  assign_bd_address -offset 0x50000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces axi_sum_example/Data_m_axi_gmem] [get_bd_addr_segs hbm/SAXI_30/HBM_MEM05] -force
  assign_bd_address -offset 0x60000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces axi_sum_example/Data_m_axi_gmem] [get_bd_addr_segs hbm/SAXI_30/HBM_MEM06] -force
  assign_bd_address -offset 0x70000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces axi_sum_example/Data_m_axi_gmem] [get_bd_addr_segs hbm/SAXI_30/HBM_MEM07] -force
  assign_bd_address -offset 0x80000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces axi_sum_example/Data_m_axi_gmem] [get_bd_addr_segs hbm/SAXI_30/HBM_MEM08] -force
  assign_bd_address -offset 0x90000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces axi_sum_example/Data_m_axi_gmem] [get_bd_addr_segs hbm/SAXI_30/HBM_MEM09] -force
  assign_bd_address -offset 0xA0000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces axi_sum_example/Data_m_axi_gmem] [get_bd_addr_segs hbm/SAXI_30/HBM_MEM10] -force
  assign_bd_address -offset 0xB0000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces axi_sum_example/Data_m_axi_gmem] [get_bd_addr_segs hbm/SAXI_30/HBM_MEM11] -force
  assign_bd_address -offset 0xC0000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces axi_sum_example/Data_m_axi_gmem] [get_bd_addr_segs hbm/SAXI_30/HBM_MEM12] -force
  assign_bd_address -offset 0xD0000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces axi_sum_example/Data_m_axi_gmem] [get_bd_addr_segs hbm/SAXI_30/HBM_MEM13] -force
  assign_bd_address -offset 0xE0000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces axi_sum_example/Data_m_axi_gmem] [get_bd_addr_segs hbm/SAXI_30/HBM_MEM14] -force
  assign_bd_address -offset 0xF0000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces axi_sum_example/Data_m_axi_gmem] [get_bd_addr_segs hbm/SAXI_30/HBM_MEM15] -force
  assign_bd_address -offset 0x000100000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces axi_sum_example/Data_m_axi_gmem] [get_bd_addr_segs hbm/SAXI_30/HBM_MEM16] -force
  assign_bd_address -offset 0x000110000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces axi_sum_example/Data_m_axi_gmem] [get_bd_addr_segs hbm/SAXI_30/HBM_MEM17] -force
  assign_bd_address -offset 0x000120000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces axi_sum_example/Data_m_axi_gmem] [get_bd_addr_segs hbm/SAXI_30/HBM_MEM18] -force
  assign_bd_address -offset 0x000130000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces axi_sum_example/Data_m_axi_gmem] [get_bd_addr_segs hbm/SAXI_30/HBM_MEM19] -force
  assign_bd_address -offset 0x000140000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces axi_sum_example/Data_m_axi_gmem] [get_bd_addr_segs hbm/SAXI_30/HBM_MEM20] -force
  assign_bd_address -offset 0x000150000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces axi_sum_example/Data_m_axi_gmem] [get_bd_addr_segs hbm/SAXI_30/HBM_MEM21] -force
  assign_bd_address -offset 0x000160000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces axi_sum_example/Data_m_axi_gmem] [get_bd_addr_segs hbm/SAXI_30/HBM_MEM22] -force
  assign_bd_address -offset 0x000170000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces axi_sum_example/Data_m_axi_gmem] [get_bd_addr_segs hbm/SAXI_30/HBM_MEM23] -force
  assign_bd_address -offset 0x000180000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces axi_sum_example/Data_m_axi_gmem] [get_bd_addr_segs hbm/SAXI_30/HBM_MEM24] -force
  assign_bd_address -offset 0x000190000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces axi_sum_example/Data_m_axi_gmem] [get_bd_addr_segs hbm/SAXI_30/HBM_MEM25] -force
  assign_bd_address -offset 0x0001A0000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces axi_sum_example/Data_m_axi_gmem] [get_bd_addr_segs hbm/SAXI_30/HBM_MEM26] -force
  assign_bd_address -offset 0x0001B0000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces axi_sum_example/Data_m_axi_gmem] [get_bd_addr_segs hbm/SAXI_30/HBM_MEM27] -force
  assign_bd_address -offset 0x0001C0000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces axi_sum_example/Data_m_axi_gmem] [get_bd_addr_segs hbm/SAXI_30/HBM_MEM28] -force
  assign_bd_address -offset 0x0001D0000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces axi_sum_example/Data_m_axi_gmem] [get_bd_addr_segs hbm/SAXI_30/HBM_MEM29] -force
  assign_bd_address -offset 0x0001E0000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces axi_sum_example/Data_m_axi_gmem] [get_bd_addr_segs hbm/SAXI_30/HBM_MEM30] -force
  assign_bd_address -offset 0x0001F0000000 -range 0x10000000 -target_address_space [get_bd_addr_spaces axi_sum_example/Data_m_axi_gmem] [get_bd_addr_segs hbm/SAXI_30/HBM_MEM31] -force
  ...
  assign_bd_address -offset 0x00800000 -range 0x00010000 -target_address_space [get_bd_addr_spaces shell_axil_ctrl] [get_bd_addr_segs axi_sum_example/s_axi_control/Reg] -force
